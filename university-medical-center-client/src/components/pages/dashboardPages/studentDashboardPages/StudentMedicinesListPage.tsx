...
export default function StudentMedicinesListPage() {
    ...
    <div className="min-h-screen bg-slate-50 py-10 px-4">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-slate-500 text-sm mt-0.5">Browse available medicines and their details</p>
        </div>
        ...
        <div className="relative max-w-sm">
          ...
          <Input
            ...
            className="pl-9 h-10 border-slate-200 focus-visible:ring-purple-500 bg-white"
            value={search}
            ...
            <Table>
              ...
              <TableBody>
                {loading ? (
                  ...
                  filtered.map((med) => (
                    <TableRow key={med.id} className="hover:bg-purple-50/40 transition-colors border-b border-slate-50">
                      ...
                      <TableCell className="pr-6 text-right">
                        <Button asChild size="sm" variant="ghost" className="h-8 gap-1 text-purple-600 hover:text-purple-700 hover:bg-purple-50">
