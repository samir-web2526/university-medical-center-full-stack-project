...
export default function WriteBlogPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const { error } = await createBlog(payload);
        ...
        <Card className="border-0 shadow-md dark:bg-slate-900 dark:border dark:border-slate-800">
          <CardHeader className="pb-3">
            ...
            <CardDescription className="text-slate-500 dark:text-slate-400 text-sm">
              Write your blog title and content
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="pt-5 space-y-4">
            <div className="space-y-1.5">
              ...
              <Input
                placeholder="e.g. Understanding Hypertension: A Guide for Students"
                value={title}
            ...
            <div className="space-y-1.5">
              ...
              <Textarea
                ...
                className="resize-none border-slate-200 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 focus-visible:ring-emerald-500 min-h-60 rounded-xl"
              />
            </div>
          </CardContent>
        </Card>
