          ...
          {steps.map((step, index) => (
            <div key={step.step} className="relative text-center space-y-4">
              ...
              <div className="relative inline-flex">
                ...
                <span className="absolute -top-2 -right-2 w-7 h-7 rounded-full bg-[#0b5394] dark:bg-[#2196f3] text-white text-xs font-bold flex items-center justify-center shadow-md">
                  {step.step}
                </span>
              </div>
